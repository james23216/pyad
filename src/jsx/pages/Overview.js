...
const ApexBar3 = loadable(() => import("../components/charts/apexcharts/Bar3"));
const ApexLine5 = loadable(() => import("../components/charts/apexcharts/Line5"));
    ...
    <div>
      <div className="form-head d-flex mb-3 mb-md-4 align-items-start">
        <div className="mr-auto d-none d-lg-block">
          <h3 className="text-black font-w600">Welcome to PatientXpress!</h3>
